...
public class DispatcherServlet extends FrameworkServlet {
	...
	static {
		...
		try {
			// 将资源文件DispatcherServlet.properties 加载
	...
	protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			try {
				 ...
				 * 这里并不会直接返回controller,而是返回HandlerExecutionChain 请求处理链对香港
				 * 该对象封装了Handler和Inceptor
				 */
	...
	protected HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
		/**
		 * 初始阶段会初始化两个handlerMaping
		 * 1.BeanNameUrlHandlerMapping 	XML格式Mapping
		 * 2.RequestMappingHandlerMapping	注解格式Mapping
		 */
		if (this.handlerMappings != null) {
	...
	protected HandlerAdapter getHandlerAdapter(Object handler) throws ServletException {
		...
		if (this.handlerAdapters != null) {
			for (HandlerAdapter adapter : this.handlerAdapters) {
				/**
				 *	判断定义Handler方式
				 * 1.HttpRequestHandlerAdapter		实现HttpRequestHandler方式定义Handler
				 * 2.SimpleControllerHandlerAdapter		实现接口定义Handler
				 * 3.RequestMappingHandlerAdapter		实现HandlerMethod定义Handler
				 */
